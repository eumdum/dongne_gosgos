<template>
  <div v-if="isOwnerChecked" class="product-page">
    <h2 class="page-title">📚 빵 사전 </h2>

    <div class="top-actions">
      <button class="back-btn" @click="goOwnerPage">← 관리자 메뉴로</button>
    </div>
...
const getImageUrl = (path) => {
  ...
  // Vite 환경변수를 읽고, 없으면 Vue CLI 환경변수, 모두 없으면 fallback으로 상대경로 사용
...
.section-title {
  ...
  margin-bottom: 20px;
  color: #3A5635;
  -webkit-text-stroke: 0.3px #202020;
